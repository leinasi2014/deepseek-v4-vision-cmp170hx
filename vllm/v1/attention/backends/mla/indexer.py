    ...
    def _prepare_decode_tensors(
        ...
        if not use_native and max_decode_len > 1:
            ...
            if use_native and next_n > 1:
                ...
                # Padding requests have seq_len == 0. Clamp their per-token
                # lengths so the sparse top-k kernels never reinterpret a
                # negative int32 as a multi-billion uint32 row length.
                seq_lens_buffer[:] = (
